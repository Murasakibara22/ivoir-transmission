...
<div class="flex flex-col h-full">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        ...
        <a href="{{ route('entreprise.reports.index') }}" class="nav-item {{ request()->routeIs('entreprise.reports.*') ? 'active' : '' }}">
            ...
            <span>Rapports & Paiements</span>
        </a>

        <a href="{{ route('entreprise.profile.index') }}" class="nav-item {{ request()->routeIs('entreprise.profile.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('entreprise.contrats.index') }}" class="nav-item {{ request()->routeIs('entreprise.contrats.*') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
