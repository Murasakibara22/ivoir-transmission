            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">POLITIQUE DE CONFIDENTIALITE</h4>
            ...
            <div class="row">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <button class="btn @if($list_privacy)  btn-warning @else btn-primary @endif createFile-modal" @if($list_privacy) wire:click="edit" @else wire:click="addPrivacy" @endif ><i class="ri-add-circle-line align-bottom me-1"></i> @if($list_privacy) Modifier @else Ajouter @endif  </button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-10">
                            <div class="card">
                                <div class="bg-soft-warning position-relative">
                                    <div class="card-body p-5">
                                        <div class="text-center">
                                            <h3>Politique de Confidentialités</h3>
                                            <p class="mb-0 text-muted">{{ $list_privacy ? date('d M, Y', strtotime($list_privacy->created_at)) : '' }}</p>
                                        </div>
                                    </div>
                                    <div class="shape">
                                ...
                                <div class="card-body p-4">
                                        ...
                                        {!!  $list_privacy->content ?? 'Aucune description' !!}
        ...
        <div class="modal-dialog modal-lg ">
            <div class="modal-content">
                ...
                <div class="modal-body text-center p-4">
                    <form @if($list_privacy) wire:submit.prevent='updatePrivacy' @else wire:submit.prevent='store' @endif>
                        <div class="row">
                            <div class="col-12">
