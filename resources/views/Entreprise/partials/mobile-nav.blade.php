...
<div class="mobile-nav">
    ...
    <a href="{{ route('entreprise.maintenance.index') }}"  window.location.href="{{ route('entreprise.maintenance.index') }}" class="mobile-nav-item {{ request()->routeIs('entreprise.maintenance.*') ? 'active' : '' }}" data-view="planning">
        <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('entreprise.contrats.index') }}" class="mobile-nav-item {{ request()->routeIs('entreprise.contrats.*') ? 'active' : '' }}">
        <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
