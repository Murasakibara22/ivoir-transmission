<!-- Modal Add Vehicule -->
@if($showAddVehiculeModal)
<div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0,0,0,0.5);">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary-subtle">
                <h5 class="modal-title">
                    <i class="ri-car-line me-2"></i>Ajouter un véhicule
                </h5>
                <button type="button" wire:click="closeAddVehiculeModal" class="btn-close"></button>
            </div>
            <form wire:submit.prevent="saveVehicule">
                ...
                <div class="modal-footer">
                    <button type="button" wire:click="closeAddVehiculeModal" class="btn btn-light">
                        <i class="ri-close-line me-1"></i>Annuler
                    </button>
                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                        <span wire:loading.remove wire:target="saveVehicule">
                            <i class="ri-save-line me-1"></i>Enregistrer
                        </span>
                        <span wire:loading wire:target="saveVehicule">
