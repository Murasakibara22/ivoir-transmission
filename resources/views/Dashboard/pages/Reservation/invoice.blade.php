                        ...
                        <div class="card-body p-4 border-top border-top-dashed">
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    @if($show_reservation->adresse == null)
                                        <p class="fw-medium mb-2" id="shipping-name">Récupération sur place</p>
                                    @else
                                    <p class="text-muted mb-1" id="shipping-address-line-1">{{$show_reservation->adresse}}</p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tbody id="products-list">
                                        @if($show_reservation->produit()->get() && count($show_reservation->produit()->get()) > 0)
                                        @foreach($show_reservation->produit()->get() as $key => $produit)
                                        <tr>
